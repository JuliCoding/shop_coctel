...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="name" class="box" placeholder="Ingresar el nombre del producto" required>
      <input type="number" min="0" name="price" class="box" placeholder="Ingresar el precio del producto " required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">No hay producto añadidos todavia!</p>';
      }
      ?>
   </div>
