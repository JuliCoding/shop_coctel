...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="password" placeholder="Ingresa tu nueva contraseña" required class="box">
      <input type="password" name="cpassword" placeholder="Confirmar nueva contraseña" required class="box">
